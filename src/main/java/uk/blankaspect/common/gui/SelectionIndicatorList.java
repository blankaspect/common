...
////////////////////////////////////////////////////////////////////////
	...
	protected void paintComponent(Graphics gr)
	{
		...
		if (currentIndex >= 0)
		{
			...
			int y = BORDER_TOP + currentIndex * rowHeight + TEXT_TOP_MARGIN +
																		(rowHeight - MARKER_HEIGHT + 1) / 2;
		...
		for (int i = startIndex; i <= endIndex; i++)
		{
			...
			String str = TextUtils.getLimitedWidthString(items.get(i).toString(), fontMetrics,
														 maxTextWidth, TextUtils.RemovalMode.END);
