...
Windows file associations class.
...
package uk.blankaspect.common.windows;
...
////////////////////////////////////////////////////////////////////////
	...
	private static final	String	HEADER_COMMENT1	= "This Windows PowerShell script was automatically generated by "
														+ "the %1 application to add and remove Windows Registry "
	...
	(
		...
		"[System.Collections.ArrayList]$keyMap =",
		"@(",
		"@(",
		"$path,",
		"@(),",
		...
		"}",
		"New-ItemProperty -Path $path -Name $entry[3] -Value $entry[4] -PropertyType $entry[5] | Out-Null",
		"}",
		"}",
		"}"
	);
		...
		for (String line : lines)
		{
			...
			if (!line.isEmpty())
			{
				if (spaces.length < indent)
					spaces = StringUtils.createCharArray(' ', indent);
...
////////////////////////////////////////////////////////////////////////
						  ...
						  List<String> extensions)
	{
		...
		map.put(FileKindParam.EXTENSIONS,     extensions.stream().collect(Collectors.joining(EXTENSION_SEPARATOR)));
