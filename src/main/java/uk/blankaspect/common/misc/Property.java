...
////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////
							   ...
							   int      maxNumValues)
		{
			...
			values = new EnumMap<>(mapKeyClass);
			for (E mapKey : mapKeyClass.getEnumConstants())
				values.put(mapKey, new ArrayList<T>());
		}
	...
	////////////////////////////////////////////////////////////////////
			...
			throws IllegalValueException, ValueOutOfBoundsException
		{
			try
			{
				return ColourUtils.parseColour(getValue());
			}
	...
	////////////////////////////////////////////////////////////////////
							  ...
							  Input        input)
		{
			...
			setSubstitutionStrings(exception.getSubstitutionStrings());
		}
