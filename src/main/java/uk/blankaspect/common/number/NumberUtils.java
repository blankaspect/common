...
////////////////////////////////////////////////////////////////////////
	...
	public static DigitCase setDigitCase(DigitCase digitCase)
	{
	...
	public static int parseDigitUpper(char ch,
									  int  radix)
	{
	...
	public static int parseDigitLower(char ch,
									  int  radix)
	{
		for (int i = 0; i < radix; i++)
		{
	...
	public static boolean isDigitCharUpper(char ch,
										   int  radix)
	{
	...
	public static boolean isDigitCharLower(char ch,
										   int  radix)
	{
	 ...
	 * @return the number of digits in the decimal representation of <i>value</i>.
	 */
	...
	public static double bytesToDoubleBE(byte[] data)
	{
	...
	public static double bytesToDoubleLE(byte[] data)
	{
	...
	public static void doubleToBytesBE(double value,
									   byte[] buffer)
	{
	...
	public static void doubleToBytesLE(double value,
									   byte[] buffer)
	{
	 ...
	 * @return a decimal string representation of <i>value</i>.
	 */
	 ...
	 *           the unsigned number for which a decimal string representation is required.
	 * @param  numDigits
	 *           the number of decimal digits in the string representation of <i>value</i>.  If <i>numDigits</i> is 0 or
	 *           negative, the string representation will not be truncated or padded.
	 * @param  padChar
	 *           the character with which the returned string will be padded on the left if the length of the string
	 *           representation of <i>value</i> is less than <i>numDigits</i>.
	 * @return a decimal string representation of <i>value</i> that may be truncated or padded on the left in the way
	 *         described above.
	 */
	 ...
	 * @param  numDigits
	 *           the number of digits in the string representation of <i>value</i>.
	 * @param  padChar
	 *           the character with which the returned string will be padded on the left if the length of the string
	 *           representation of <i>value</i> is less than <i>numDigits</i>.
	 * @param  radix
	 *           the radix of the string representation of <i>value</i>.
	 * @return a string representation of <i>value</i> that may be truncated or padded on the left in the way described
	 *         above.
	 */
									  ...
									  int  radix)
	{
		...
		// Validate arguments
		if (numDigits < 1)
			throw new IllegalArgumentException("Number of digits out of bounds");
									   ...
									   int  radix)
	{
		...
		if (value < 0)
		{
			...
			if (length < numDigits)
				str = StringUtils.createCharString(padChar, numDigits - length) + str;
	 ...
	 * @return the signed integer represented by the binary string <i>str</i>.
	 * @throws NumberFormatException
	 *           if <i>str</i> is not a valid binary representation of an integer.
	 * @throws ValueOutOfBoundsException
	 *           if the result of parsing <i>str</i> cannot be represented in 32 bits.
	 */
	 ...
	 * @param  str
	 *           the string that is to be parsed.
	 * @return the signed integer represented by the decimal string <i>str</i>.
	 * @throws NumberFormatException
	 *           if <i>str</i> is not a valid decimal representation of an integer.
	 * @throws ValueOutOfBoundsException
	 *           if the result of parsing <i>str</i> cannot be represented in 32 bits.
	 */
	 ...
	 * @param  str
	 *           the string that is to be parsed.
	 * @return the signed integer represented by the hexadecimal string <i>str</i>.
	 * @throws NumberFormatException
	 *           if <i>str</i> is not a valid hexadecimal representation of an integer.
	 * @throws ValueOutOfBoundsException
	 *           if the result of parsing <i>str</i> cannot be represented in 32 bits.
	 */
	 ...
	 * @param  str
	 *           the string that is to be parsed.
	 * @return the signed integer represented by <i>str</i>.
	 * @throws NumberFormatException
	 *           if <i>str</i> does not represent a valid integer in any of the supported radices.
	 * @throws ValueOutOfBoundsException
	 *           if the result of parsing <i>str</i> cannot be represented in 32 bits.
	 */
	 ...
	 * @param  str
	 *           the string that is to be parsed.
	 * @return the unsigned integer represented by the binary string <i>str</i>.
	 * @throws NumberFormatException
	 *           if <i>str</i> is not a valid binary representation of an integer.
	 * @throws ValueOutOfBoundsException
	 *           if the result of parsing <i>str</i> cannot be represented in 32 bits.
	 ...
	 * @param  str
	 *           the string that is to be parsed.
	 * @return the unsigned integer represented by the decimal string <i>str</i>.
	 * @throws NumberFormatException
	 *           if <i>str</i> is not a valid decimal representation of an integer.
	 * @throws ValueOutOfBoundsException
	 *           if the result of parsing <i>str</i> cannot be represented in 32 bits.
	 ...
	 * @param  str
	 *           the string that is to be parsed.
	 * @return the unsigned integer represented by the hexadecimal string <i>str</i>.
	 * @throws NumberFormatException
	 *           if <i>str</i> is not a valid hexadecimal representation of an integer.
	 * @throws ValueOutOfBoundsException
	 *           if the result of parsing <i>str</i> cannot be represented in 32 bits.
	 ...
	 * @param  str
	 *           the string that is to be parsed.
	 * @return the unsigned integer represented by <i>str</i>.
	 * @throws NumberFormatException
	 *           if <i>str</i> does not represent a valid integer in any of the supported radices.
	 * @throws ValueOutOfBoundsException
	 *           if the result of parsing <i>str</i> cannot be represented in 32 bits.
	 ...
	 * @param  str
	 *           the string that is to be parsed.
	 * @return the unsigned long integer represented by the binary string <i>str</i>.
	 * @throws NumberFormatException
	 *           if <i>str</i> is not a valid binary representation of a long integer.
	 * @throws ValueOutOfBoundsException
	 *           if the result of parsing <i>str</i> cannot be represented in 64 bits.
	 */
	 ...
	 * @param  str
	 *           the string that is to be parsed.
	 * @return the unsigned long integer represented by the decimal string <i>str</i>.
	 * @throws NumberFormatException
	 *           if <i>str</i> is not a valid decimal representation of a long integer.
	 * @throws ValueOutOfBoundsException
	 *           if the result of parsing <i>str</i> cannot be represented in 64 bits.
	 */
	 ...
	 * @param  str
	 *           the string that is to be parsed.
	 * @return the unsigned long integer represented by the hexadecimal string <i>str</i>.
	 * @throws NumberFormatException
	 *           if <i>str</i> is not a valid hexdecimal representation of a long integer.
	 * @throws ValueOutOfBoundsException
	 *           if the result of parsing <i>str</i> cannot be represented in 64 bits.
	 */
	 ...
	 * @param  str
	 *           the string that is to be parsed.
	 * @return the unsigned long integer represented by <i>str</i>.
	 * @throws NumberFormatException
	 *           if <i>str</i> does not represent a valid long integer in any of the supported radices.
	 * @throws ValueOutOfBoundsException
	 *           if the result of parsing <i>str</i> cannot be represented in 64 bits.
	 */
										  ...
										  String suffix)
	{
		...
		int numLines = (bytesPerLine == 0) ? 1 : roundUpQuotientInt(length, bytesPerLine);

		StringBuilder buffer = new StringBuilder((charsPerByte * length + extraCharsPerLine) * numLines);
	...
	public static String intsToHexString(int[]  data,
										 int    intsPerLine,
										 int    numDigits,
										 String separator)
	{
										 ...
										 String suffix)
	{
		...
		int numLines = (intsPerLine == 0) ? 1 : roundUpQuotientInt(length, intsPerLine);
