...
Multiple file selection dialog box class.
...
////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////
		...
		public boolean canImport(TransferHandler.TransferSupport support)
		{
			...
			if (supported)
				supported = capabilities.contains(Capability.ADD) &&
...
////////////////////////////////////////////////////////////////////////
										  ...
										  boolean         show)
	{
		...
		// Button: accept
		JButton acceptButton = new FButton((acceptStr == null) ? Constants.OK_STR : acceptStr);
	...
	private void showContextMenu(MouseEvent event)
	{
		if (event.isPopupTrigger())
		{
			...
			try
			{
				...
				getPasteAction().setEnabled(capabilities.contains(Capability.ADD) &&
											DataImporter.isFileList(flavours));
			}
			catch (Exception e)
			{
				// ignore
