...
////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////
		...
		private ModelEvent(SingleSelectionList<?> source)
		{
			super(source);
		}
...
////////////////////////////////////////////////////////////////////////
	...
	public SingleSelectionList(int  columns,
							   int  viewableRows,
							   Font font)
	{
							   ...
							   Font font)
	{
		...
		this.columnWidth = (columnWidth == 0) ? GuiUtils.getCharWidth('0', fontMetrics) : columnWidth;
...
////////////////////////////////////////////////////////////////////////
	...
	protected static String truncateText(String      text,
										 ...
										 int         maxTextWidth)
	{
		...
		{
			maxTextWidth -= fontMetrics.stringWidth(Constants.ELLIPSIS_STR);
...
////////////////////////////////////////////////////////////////////////
	...
	{
		return new Dimension(2 * horizontalMargin + columns * columnWidth + extraWidth,
							 Math.max(viewableRows, getNumElements()) * rowHeight);
	}
...
////////////////////////////////////////////////////////////////////////
	...
	public void setModel(IModel<E> model)
	{
		this.model = model;
		resizeAndRedraw();
	}
	...
	protected Color getBackgroundColour(int index)
	{
		return ((index == selectedIndex) ? isFocusOwner()
	...
	protected Color getForegroundColour(int index)
	{
							   ...
							   int      index)
	{
		...
		gr.drawString(text, horizontalMargin,
	...
	protected void showPopUp(int index)
	{
	...
	protected void forceSelectedIndex(int index)
	{
	...
	private void redrawElements(int index,
								int length)
	{
	...
	private void setDragIndex(int index)
	{
		// Erase old drag bar
		if (dragY != null)
		{
	...
	private void incrementSelectedIndex(int increment)
	{
	...
	private void incrementViewY(int deltaY)
	{
		if (deltaY != 0)
			viewport.setViewPosition(new Point(viewport.getViewPosition().x,
											   viewport.getViewPosition().y + deltaY));
	}
