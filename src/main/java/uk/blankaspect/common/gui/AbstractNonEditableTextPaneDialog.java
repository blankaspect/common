...
Abstract non-editable text pane dialog box class.
...
////////////////////////////////////////////////////////////////////////
												...
												String       defaultButtonKey)
	{
		...
		GuiUtils.setAppFont(fontKey, textPane);
		...
		JScrollPane textPaneScrollPane = new JScrollPane(textPanePanel,
														 JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
														 JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
		FontMetrics fontMetrics = textPane.getFontMetrics(textPane.getFont());
		int width = numColumns * GuiUtils.getCharWidth('0', fontMetrics);
		int height = numRows * fontMetrics.getHeight();
		textPaneScrollPane.getViewport().setPreferredSize(new Dimension(width, height));
		textPaneScrollPane.setViewportBorder(BorderFactory.
														createMatteBorder(TEXT_PANE_VERTICAL_MARGIN,
