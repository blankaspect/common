...
////////////////////////////////////////////////////////////////////////
	...
	public LinkedPairButton(String tooltipText)
	{
		// Set attributes
		setBorder(null);
		setPreferredSize(new Dimension(2 * HORIZONTAL_MARGIN +
															(int)(2.0 * ICON_DISC_DIAMETER + ICON_DISC_GAP),
	...
	protected void paintComponent(Graphics gr)
	{
		...
		if (isSelected())
		{
			...
			gr2d.fill(new Rectangle2D.Double(0.5 * ((double)width - ICON_RECT_WIDTH),
											 0.5 * ((double)height - ICON_RECT_HEIGHT),
											 ICON_RECT_WIDTH, ICON_RECT_HEIGHT));
		}
		gr.setColor(isEnabled() ? ICON_DISC_COLOUR : DISABLED_COLOUR);
		gr2d.fill(new Ellipse2D.Double((double)HORIZONTAL_MARGIN, (double)VERTICAL_MARGIN,
		...
		if (isFocusOwner())
		{
			gr2d.setStroke(Constants.BASIC_DASH);
