...
////////////////////////////////////////////////////////////////////////
	...
	{
		this(columns, viewableRows, elements, maxNumElements, closeButtons,
			 EnumSet.noneOf(CommandId.class));
	}
									...
									Set<CommandId> immediateCommands)
	{
		...
		// Selection list
		list = new SingleSelectionList<>(columns, viewableRows,
										 GuiUtils.getAppFont(Constants.FontKey.MAIN), elements);
		...
		// Button: add
		addButton = new FButton(immediateCommands.contains(CommandId.ADD)
																	? ADD_STR
																	: ADD_STR + Constants.ELLIPSIS_STR);
		...
		// Button: edit
		editButton = new FButton(immediateCommands.contains(CommandId.EDIT)
																	? EDIT_STR
																	: EDIT_STR + Constants.ELLIPSIS_STR);
		...
		deleteButton = new FButton(immediateCommands.contains(CommandId.DELETE)
																	? DELETE_STR
																	: DELETE_STR + Constants.ELLIPSIS_STR);
