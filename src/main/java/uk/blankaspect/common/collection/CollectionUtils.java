...
////////////////////////////////////////////////////////////////////////
	 ...
	 * @return {@code true} if <i>collection</i> is {@code null} or empty; {@code false} otherwise.
	 */
	 ...
	 * @param numElements
	 *          the number of elements that will be added to <i>collection</i>.
	 * @param source
	 *          the function that provides the elements that will be added to <i>collection</i>.  The function has a
	 ...
	 * @return a list of {@link Integer}s whose elements are the boxed equivalents of the elements of <i>values</i>.
	 */
	 ...
	 * @return an array of {@code int}s whose elements are the unboxed equivalents of the elements of <i>values</i>.
	 */

	public static int[] intsToArray(Collection<Integer> values)
	{
	 ...
	 * @return a list of {@link Long}s whose elements are the boxed equivalents of the elements of <i>values</i>.
	 */

	public static List<Long> longsToList(long[] values)
	{
	 ...
	 * @return an array of {@code long}s whose elements are the unboxed equivalents of the elements of <i>values</i>.
	 */

	public static long[] longsToArray(Collection<Long> values)
	{
	...
	public static List<Double> doublesToList(double[] values)
	{
	 ...
	 * @return an array of {@code double}s whose elements are the unboxed equivalents of the elements of <i>values</i>.
	 */

	public static double[] doublesToArray(Collection<Double> values)
	{
