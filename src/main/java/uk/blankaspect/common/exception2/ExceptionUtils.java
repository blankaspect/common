...
////////////////////////////////////////////////////////////////////////
	 ...
	 * @return a list of string representations of the stack traces of <i>exception</i> and its chain of causes.
	 */
	 ...
	 * @param  cause
	 *           the proximate cause.
	 * @return a list of string representations of the chain of causes whose first element is <i>cause</i>.
	 */
	 ...
	 * @return a composite string representation of the chain of causes whose first element is <i>cause</i>.
	 */
	...
	/**
	 * Writes a following items to the standard error stream on separate lines:
	...
	public static void printStderrLocated(Object obj)
	{
