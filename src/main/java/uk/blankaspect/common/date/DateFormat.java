	...
	////////////////////////////////////////////////////////////////////
		...
		private String toString(Calendar date)
		{
			...
			switch (kind)
			{
				...
				case DAY:
					str = NumberUtils.uIntToDecString(date.get(Calendar.DAY_OF_MONTH), width, padChar);
					break;
				...
				case DAY_NAME:
					str = DateUtils.getDayNames().get(date.get(Calendar.DAY_OF_WEEK) - Calendar.SUNDAY);
					break;
			}
