...
package uk.blankaspect.common.swing.image;
...
////////////////////////////////////////////////////////////////////////
	...
	private static final	String	FAILED_TO_FIND_IMAGE_STR	= "Failed to find the image '%1'; "
	...
	/** The PNG image data of the default image. */
	private static final	byte[]	DEFAULT_IMAGE_DATA	=
	{
...
////////////////////////////////////////////////////////////////////////
	...
	/** A list of pathnames of directories that contains images. */
...
////////////////////////////////////////////////////////////////////////
	...
	static
	{
		...
		try
		{
			image = ImageIO.read(new ByteArrayInputStream(DEFAULT_IMAGE_DATA));
		}
		catch (IOException e)
		{
			e.printStackTrace();
...
////////////////////////////////////////////////////////////////////////
								 ...
								 boolean defaultIfNotFound)
	{
		...
		// If image is not in cache and its resource was not found, use default image
		if ((image == null) && defaultIfNotFound)
		{
			...
			// Report failure
			System.err.println(IndexedSub.sub(FAILED_TO_FIND_IMAGE_STR, filename));
	...
	public static void addDirectory(Class<?> cls,
									String   pathname)
	{
		directories.addFirst(ResourceUtils.absoluteName(cls, pathname));
	}
