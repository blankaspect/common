...
import uk.blankaspect.common.swing.list.SelectionIndicatorList;
...
////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////
		...
		private MouseSelectionListWindow(Window owner)
		{
			...
			orderedElements.sort(elementComparator);
...
////////////////////////////////////////////////////////////////////////
					   ...
					   boolean     directTabTraversal)
	{
		...
		selectedIndex = -1;
		elementComparator = (element1, element2) ->
				ignoreCase ? element1.toString().compareToIgnoreCase(element2.toString())
