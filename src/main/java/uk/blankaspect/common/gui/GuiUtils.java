...
////////////////////////////////////////////////////////////////////////
	...
	public static int getBaselineOffset(int         height,
										FontMetrics fontMetrics)
	{
	...
	public static Rectangle getComponentScreenBounds(Component component)
	{
		...
		return ((screenRect == null) ? screenRects.isEmpty() ? new Rectangle() : new Rectangle(screenRects.get(0))
									 : screenRect);
	}
	...
	public static boolean isAppFont(String key)
	{
		try
		{
	...
	public static Font getAppFont(String key)
	{
		Font font = null;
		try
		{
	...
	public static void setAppFont(String    key,
								  Component component)
	{
		try
		{
