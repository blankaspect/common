...
////////////////////////////////////////////////////////////////////////
	 ...
	 *
	 * @param  seq  the sequence that will be escaped.
	 ...
	 *
	 * @param  exception  the exception for which a message is required.
	 * @return a message for {@code exception}.
	 */

	public static String getExceptionMessage(PatternSyntaxException exception)
	{
