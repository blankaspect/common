...
package uk.blankaspect.common.swing.range;
...
import uk.blankaspect.common.swing.dialog.RangeBarDialog;
	...
	protected void showDialog()
	{
		...
		switch (orientation)
		{
			case VERTICAL:
			{
				...
				Rectangle rect = new Rectangle(rangeBarButton.getLocationOnScreen(), rangeBarButton.getSize());
