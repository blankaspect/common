...
////////////////////////////////////////////////////////////////////////
	...
	// STRICT ARRAY SET CLASS


	/**
	 * This class extends {@link ArraySet}, imposing the condition of distinct set elements on its {@code
	 * set(int, E)} method.  As a consequence of this, the utility methods of {@link java.util.Collections}
	 * that use such as {@link java.util.List#set(int, E)}, such as {@link
	 * java.util.Collections#sort(java.util.List)}, will fail with an {@link ElementAlreadyExistsException}.
	 *
	...
	// ELEMENT ALREADY EXISTS EXCEPTION CLASS
