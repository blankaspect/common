...
////////////////////////////////////////////////////////////////////////
									  ...
									  boolean utc)
	{
		...
		buffer.append('-');
		buffer.append(NumberUtils.uIntToDecString(calendar.get(Calendar.MONTH) + 1, NUM_MONTH_DIGITS,
												  '0'));
		buffer.append('-');
		buffer.append(NumberUtils.uIntToDecString(calendar.get(Calendar.DAY_OF_MONTH), NUM_DAY_DIGITS,
												  '0'));
		buffer.append(separator);
		buffer.append(NumberUtils.uIntToDecString(calendar.get(Calendar.HOUR_OF_DAY), NUM_HOUR_DIGITS,
												  '0'));
		buffer.append(':');
		buffer.append(NumberUtils.uIntToDecString(calendar.get(Calendar.MINUTE), NUM_MINUTE_DIGITS,
												  '0'));
		buffer.append(':');
		buffer.append(NumberUtils.uIntToDecString(calendar.get(Calendar.SECOND), NUM_SECOND_DIGITS,
												  '0'));
		if (showMilliseconds)
		{
			buffer.append('.');
			buffer.append(NumberUtils.uIntToDecString(calendar.get(Calendar.MILLISECOND),
													  NUM_MILLISECOND_DIGITS, '0'));
		}
